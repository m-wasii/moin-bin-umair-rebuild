...
const videoTitle = document.querySelector<HTMLElement>('[data-video-dialog-title]');
const externalLink = document.querySelector<HTMLAnchorElement>('[data-video-external]');
...
document.addEventListener('click', (event) => {
	...
	if (!link || !videoDialog || !videoPlayer || typeof videoDialog.showModal !== 'function') {
		return;
	}
