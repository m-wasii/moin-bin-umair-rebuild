...
const ui = {
	en: {
		...
		"hero.edge": "Proof sheet · Select a frame",
		"hero.explore": "Explore the work",
		"hero.contact": "Get in touch",
		"portals.aria": "Enter the work",
		"portals.enter": "Enter",
		"portals.films.meta": "Film · Story · Image",
		"portals.films.title": "Films",
		"portals.photos.meta": "Albums · Still · Light",
		"portals.photos.title": "Photography",
	...
	de: {
		...
		"hero.edge": "Kontaktbogen · Frame wählen",
		"hero.explore": "Arbeit entdecken",
		"hero.contact": "Kontakt aufnehmen",
		"portals.aria": "Zur Arbeit",
		"portals.enter": "Eintreten",
		"portals.films.meta": "Film · Geschichte · Bild",
		"portals.films.title": "Filme",
		"portals.photos.meta": "Alben · Still · Licht",
		"portals.photos.title": "Fotografie",
