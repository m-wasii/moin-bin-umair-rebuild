...
const albums = [
	...
	{ category: "fashion", folders: ["Fashion"] },
	{ category: "editorial", folders: ["Editorial"] },
	...
	{ category: "architecture", folders: ["Architecture"] },
	{
		...
		folders: ["Random-Experimentations", "Portraits-Fashion"],
	},
];
	...
	`${JSON.stringify(
		{
			categories: [
				...
				{
					slug: "random-experimentations",
					label: "Random Experimentations",
				},
			],
		},
		null,
